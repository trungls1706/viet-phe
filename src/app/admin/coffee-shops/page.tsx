...
import { canManageCoffeeShops, canDeleteCoffeeShops } from '@/lib/permissions';
...
export default function CoffeeShopsAdmin() {
  ...
  const handleDelete = async (id: string) => {
    if (!canDeleteCoffeeShops(user)) {
      setError('You do not have permission to delete coffee shops');
      return;
    }
